...
!function(a, b, c, d) {
    ...
    function e(b, c, d) {
        ...
        f.options = a.extend({}, a.fn.cubeportfolio.options, c, f.$obj.data("cbp-options")),
        f.isAnimating = !0,
        ...
        f.$obj.addClass("cbp"),
        (0 === g.length || g.first().hasClass("cbp-item")) && (f.wrapInner(f.obj, "cbp-wrapper"),
        f.addedWrapp = !0),
        ...
        resizeEvent: function() {
            ...
            e["private"].resize.initEvent({
                ...
                fn: function() {
                    ...
                    a.width !== a.$obj.outerWidth() && ("alignCenter" === a.options.gridAdjustment && (a.wrapper[0].style.maxWidth = ""),
                    a.layoutAndAdjustment(),
    ...
    a.extend(e.prototype, {
        mosaicLayoutReset: function() {
            ...
            b.blocksOn.each(function(c, d) {
                a(d).data("cbp").pack = !1,
                b.options.sortToPreventGaps && (d.style.height = "")
            }),
            b.freeSpaces = [{
                leftStart: 0,
...
function(a, b, c, d) {
    ...
    e["private"] = {
        ...
        browserInfo: function() {
            ...
            -1 !== h.indexOf("MSIE 8.") ? g.browser = "ie8" : -1 !== h.indexOf("MSIE 9.") ? g.browser = "ie9" : -1 !== h.indexOf("MSIE 10.") ? g.browser = "ie10" : b.ActiveXObject || "ActiveXObject"in b ? g.browser = "ie11" : /android/gi.test(h) ? g.browser = "android" : /iphone|ipad|ipod/gi.test(h) ? g.browser = "ios" : /chrome/gi.test(h) ? g.browser = "chrome" : g.browser = "",
...
function(a, b, c, d) {
    ...
    e.prototype.click = function() {
        ...
        b.loadMore.on("click.cbp", function(d) {
            var e = a(this);
            d.preventDefault(),
            b.parent.isAnimating || e.hasClass("cbp-l-loadMore-stop") || (e.addClass("cbp-l-loadMore-loading"),
            c++,
            a.ajax({
      ...
      , g = {
        ...
        createMarkup: function() {
            ...
            a(c).on("keydown.cbp", function(a) {
                b.isOpen && (b.stopEvents || (h && a.stopImmediatePropagation(),
        ...
        openLightbox: function(d, e) {
            ...
            if (!i.isOpen) {
                ...
                a.each(d, function(b, c) {
                    var d, e = c.getAttribute("href"), g = e, h = "isImage";
                    if (-1 === a.inArray(e, k)) {
                        if (f === e)
                            i.current = j;
        ...
        openSinglePage: function(d, e) {
            ...
            if (!h.isOpen) {
                ...
                h.wrap.one(f["private"].transitionend, function() {
                    ...
                    "android" !== f["private"].browser && "ios" !== f["private"].browser || (h.navigationMobile = a("<div/>", {
            ...
            "top" === j.options.singlePageInlinePosition)
                ...
                c.each(function(b, c) {
                    var d = a(c)
                      , e = d.data("cbp").top
                      , f = e + d.height();
                    l >= f || (e >= l && (j.blocksToMove = j.blocksToMove.add(c)),
                    l > e && f > l && (j.top = f + j.options.gapHorizontal,
                ...
                c.each(function(b, c) {
                    var d = a(c)
                      ...
                      , f = d.data("cbp").top
                      , g = f + e;
                    return m >= g ? void 0 : f >= m - e / 2 ? void (j.blocksToMove = j.blocksToMove.add(c)) : void (g > m && m > f && (g > j.top && (j.top = g),
        ...
        updateSinglePageIsOpen: function() {
            ...
            b.length ? (b.find(".cbp-slider-item").addClass("cbp-item"),
        ...
        close: function(c, d) {
            function e() {
                i.slider && f["private"].resize.destroyEvent(a.data(i.slider[0], "cubeportfolio")),
                i.content.html(""),
                i.wrap.detach(),
            ...
            setTimeout(function() {
                ...
                "ie8" !== f["private"].browser && "ie9" !== f["private"].browser || (i.slider && f["private"].resize.destroyEvent(a.data(i.slider[0], "cubeportfolio")),
                i.content.html(""),
                i.wrap.detach(),
                a("html").css({
                    overflow: "",
